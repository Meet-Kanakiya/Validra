...
| Prisma | To be installed | PostgreSQL ORM for auth |
...
### 5. Set Up Prisma (Database ORM)

After Prisma is added to the project:
...
> [!NOTE]
> Prisma handles auth tables (users, sessions, tokens). See [DB Schema Blueprint](../blueprints/db/prisma/schema-blueprint.md) for full table details.
