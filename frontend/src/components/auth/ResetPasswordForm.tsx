  ...
  return (
    <form className={cn("space-y-4", className)} onSubmit={handleSubmit} noValidate>
      ...
      <div>
        ...
        {errors.password && (
          <p id="reset-password-error" role="alert" className="text-xs text-rose-400 mt-1.5">
            {errors.password}
          </p>
        )}
      ...
      <div>
        ...
        {errors.confirmPassword && (
          <p id="reset-confirm-password-error" role="alert" className="text-xs text-rose-400 mt-1.5">
            {errors.confirmPassword}
          </p>
        )}
      </div>
